// Procedural pixel people: portraits (18×28) and walking scene sprites (18×32).
//
// The drawing primitives below (heads, faces, hairstyles, facial hair, glasses,
// clothing, scene bodies, outline pass) are ported from Munder Difflin's
// src/renderer/src/scene/office/portraitArt.ts, © 2026 Chaitanya Giri, MIT
// License (see THIRD_PARTY_NOTICES.md). The character recipes and the render
// API at the bottom are specific to this project.
...
// ─── recipes for the Virtual Office staff ────────────────────────────────────
const BLACK: RGB = [30, 24, 22];
const DARK_BROWN: RGB = [52, 36, 26];

export const RECIPES: Record<string, Recipe> = {
  You:     { skin: 'tan',   hairc: DARK_BROWN, hair: 'styleShort',  hairargs: { part: 'L' }, cloth: 'suit', c1: [58, 63, 74], tie: [214, 170, 60], brow: 'flat', mouth: 'smile' },
  Rohan:   { skin: 'tan',   hairc: BLACK,      hair: 'styleShort',  hairargs: { part: 'R' }, cloth: 'dressshirt', c1: [177, 151, 252], tie: [90, 70, 150], brow: 'flat', mouth: 'smile' },
  Neha:    { skin: 'brown', hairc: BLACK,      hair: 'styleFrame',  hairargs: { length: 19, vol: 2 }, cloth: 'cardigan', c1: [255, 160, 122], c2: [255, 248, 231], brow: 'soft', mouth: 'smile', blush: true, lashes: true },
  Meera:   { skin: 'tan',   hairc: BLACK,      hair: 'styleBun',    cloth: 'blouse', c1: [78, 205, 196], glasses: true, brow: 'raised', mouth: 'smile', lashes: true },
  Kabir:   { skin: 'tan',   hairc: DARK_BROWN, hair: 'styleMessy',  hairargs: { length: 9 }, cloth: 'sweater', c1: [255, 107, 107], facial: 'stubble', brow: 'flat', mouth: 'grin' },
  Zoya:    { skin: 'brown', hairc: BLACK,      hair: 'styleCurly',  cloth: 'blouse', c1: [255, 217, 61], brow: 'soft', mouth: 'smile', lashes: true },
  Vikram:  { skin: 'brown', hairc: BLACK,      hair: 'styleShort',  hairargs: { part: 'L', recede: 1 }, cloth: 'polo', c1: [107, 207, 127], c2: [80, 170, 100], facial: 'mustacheSm', brow: 'flat', mouth: 'neutral' },
  Isha:    { skin: 'tan',   hairc: BLACK,      hair: 'styleFrame',  hairargs: { length: 17, vol: 1 }, cloth: 'cardigan', c1: [61, 46, 74], c2: [230, 226, 240], glasses: true, brow: 'flat', mouth: 'neutral', lashes: true },
  Sana:    { skin: 'light', hairc: DARK_BROWN, hair: 'styleFrame',  hairargs: { length: 18, vol: 2 }, cloth: 'blouse', c1: [168, 230, 224], brow: 'soft', mouth: 'smile', blush: true, lashes: true },
  Kunal:   { skin: 'brown', hairc: BLACK,      hair: 'styleSpiky',  cloth: 'polo', c1: [255, 107, 107], c2: [200, 70, 70], brow: 'raised', mouth: 'grin' },
  Ira:     { skin: 'tan',   hairc: BLACK,      hair: 'styleBun',    cloth: 'sweater', c1: [214, 197, 255], brow: 'soft', mouth: 'smile', lashes: true },
  Aditya:  { skin: 'tan',   hairc: BLACK,      hair: 'styleShort',  hairargs: { part: 'L' }, cloth: 'dressshirt', c1: [108, 142, 245], glasses: true, brow: 'flat', mouth: 'neutral' },
  Tara:    { skin: 'dark',  hairc: BLACK,      hair: 'styleCurly',  cloth: 'blouse', c1: [107, 207, 127], brow: 'soft', mouth: 'smile', lashes: true },
  Farhan:  { skin: 'tan',   hairc: BLACK,      hair: 'styleShort',  hairargs: { part: 'R' }, cloth: 'polo', c1: [120, 120, 136], c2: [90, 90, 104], facial: 'goatee', brow: 'angry', mouth: 'neutral' },
  Riya:    { skin: 'tan',   hairc: DARK_BROWN, hair: 'styleFrame',  hairargs: { length: 16, vol: 1 }, cloth: 'cardigan', c1: [255, 107, 107], c2: [255, 248, 231], brow: 'soft', mouth: 'grin', lashes: true },
  Omar:    { skin: 'brown', hairc: BLACK,      hair: 'styleFloppy', cloth: 'sweater', c1: [78, 205, 196], facial: 'stubble', brow: 'flat', mouth: 'smile' },
  Lakshmi: { skin: 'dark',  hairc: BLACK,      hair: 'styleBun',    cloth: 'blouse', c1: [255, 217, 61], brow: 'raised', mouth: 'smile', lashes: true },
  Nikhil:  { skin: 'tan',   hairc: BLACK,      hair: 'styleFloppy', cloth: 'polo', c1: [255, 217, 61], c2: [220, 180, 40], brow: 'flat', mouth: 'grin' },
  Ananya:  { skin: 'light', hairc: DARK_BROWN, hair: 'styleFrame',  hairargs: { length: 20, vol: 2 }, cloth: 'sweater', c1: [255, 208, 181], brow: 'soft', mouth: 'smile', blush: true, lashes: true },
  Arjun:   { skin: 'brown', hairc: BLACK,      hair: 'styleMessy',  hairargs: { length: 8 }, cloth: 'sweater', c1: [61, 70, 86], facial: 'stubble', glasses: true, brow: 'flat', mouth: 'neutral' },
  Priya:   { skin: 'tan',   hairc: BLACK,      hair: 'styleFrame',  hairargs: { length: 18, vol: 1 }, cloth: 'blouse', c1: [107, 207, 127], brow: 'raised', mouth: 'smile', lashes: true },
  Manav:   { skin: 'brown', hairc: BLACK,      hair: 'styleShort',  hairargs: { part: 'L' }, cloth: 'dressshirt', c1: [232, 217, 160], tie: [110, 90, 60], brow: 'flat', mouth: 'smile', heavy: true },
  Dev:     { skin: 'tan',   hairc: BLACK,      hair: 'styleSpiky',  cloth: 'polo', c1: [255, 159, 67], c2: [220, 120, 40], glasses: true, brow: 'raised', mouth: 'grin' },
};

/** Anyone without a hand-made recipe gets a stable look derived from their name. */
function recipeFor(name: string): Recipe {
  if (RECIPES[name]) return RECIPES[name];
  let h = 0;
  for (const ch of name) h = (h * 31 + ch.charCodeAt(0)) >>> 0;
  const pick = <T,>(xs: T[]) => xs[h % xs.length];
  const tops: RGB[] = [[255, 107, 107], [107, 207, 127], [78, 205, 196], [255, 217, 61], [177, 151, 252], [255, 160, 122]];
  return {
    skin: pick(['light', 'tan', 'brown', 'dark']),
    hairc: BLACK,
    hair: pick(['styleShort', 'styleFloppy', 'styleSpiky', 'styleBun', 'styleFrame'] as HairStyle[]),
    cloth: pick(['polo', 'sweater', 'blouse', 'dressshirt'] as Cloth[]),
    c1: tops[(h >> 3) % tops.length],
    brow: 'flat',
    mouth: 'smile',
  };
}
...
// ─── render to data URLs (for <image> in SVG and <img> in the UI) ───────────
function toDataURL(buf: Buf, w: number, h: number): string {
...
/** Head-and-shoulders portrait, 18×28 px. Scale it up with image-rendering: pixelated. */
export function portraitURL(name: string): string {
  let url = portraitCache.get(name);
  if (!url) {
    url = toDataURL(compose(recipeFor(name)), PORTRAIT_W, PORTRAIT_H);
    portraitCache.set(name, url);
  }
  return url;
}

/** Full-body walking frames, 18×32 px: [standing, left step, right step]. */
export function sceneFrames(name: string): string[] {
  let frames = sceneCache.get(name);
  if (!frames) {
    const r = recipeFor(name);
    frames = [0, 1, 2].map((phase) => toDataURL(composeScene(r, phase, false), SCENE_W, SCENE_H));
